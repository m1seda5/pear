...
const Actions = ({ post }) => {
    ...
    const handleLikeAndUnlike = async () => {
        ...
        try {
            ...
            if (!liked) {
                ...
                // Competition point logic
                if (competitionActive && data.pointsAwarded) {
                    updatePoints(data.pointsAwarded);
    ...
    const handleReply = async () => {
        ...
        try {
            ...
            // Competition point logic for replies
            if (competitionActive && data.pointsAwarded) {
                updatePoints(data.pointsAwarded);
                showPointPopUp(data.pointsAwarded);
            }

            // Admin fire emoji logic
            if (competitionActive && reply === "🔥" && isAdmin) {
                showToast("Success", "Admin fire reaction added!", "success");
            }
    ...
    const handleReplyEmoji = async (emoji) => {
        ...
        try {
            ...
            // Competition point logic for emoji replies
            if (competitionActive && data.pointsAwarded) {
                updatePoints(data.pointsAwarded);
                showPointPopUp(data.pointsAwarded);
            }
            ...
            // Admin fire emoji logic
            if (competitionActive && emoji === "🔥" && isAdmin) {
                showToast("Success", "Admin fire reaction added!", "success");
            }
