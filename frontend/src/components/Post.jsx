...
const Post = ({ post, postedBy }) => {
  ...
  useEffect(() => {
    const getUser = async () => {
      try {
        console.log("Fetching user profile for:", postedBy); // Logging postedBy for debugging
        const res = await fetch("/api/users/profile/" + postedBy);
        const data = await res.json();
        console.log("User data fetched:", data); // Logging the fetched data
        ...
        console.error("Error fetching user:", error.message); // Log any fetch errors
        showToast(t("Error"), error.message, "error");
        setUser(null);
      }
    };
  ...
  const handleDeletePost = async (e) => {
    try {
      ...
      const data = await res.json();
      console.log("Delete response:", data); // Log response from deletion
      ...
      console.error("Error deleting post:", error.message); // Log any deletion errors
      showToast(t("Error"), error.message, "error");
    }
  };
