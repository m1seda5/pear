...
const CreatePost = () => {
  ...
  const handleCreatePost = async () => {
    ...
    try {
      ...
      // Set targetAudience for teacher and admin roles
      ...
      setPostText("");
      setImgUrl("");
      setTargetAudience(user.role === "teacher" || user.role === "admin" ? "all" : ""); // Reset based on role
    } catch (error) {
      showToast(t("Error"), error.message, "error");
    } finally {
      setLoading(false);
            ...
            <FormControl>
              ...
              {(user.role === "teacher" || user.role === "admin") && (
                ...
                >
                  ...
                  {user.role === "admin" && (
                    <>
                      <option value="Math Department">{t("Math Department")}</option>
                      <option value="Science Department">{t("Science Department")}</option>
